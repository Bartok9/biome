...
use biome_module_graph::{
    ...
    ModuleGraphGeneration, ModuleInfo, ModuleInfoKind, ModuleInfoOrigin, NormalizeTypeInput,
    PathInfoCache, infer_call_expression_type as infer_call_expression_type_query,
    infer_module_types, infer_module_types_bottom_up, module_for_key,
